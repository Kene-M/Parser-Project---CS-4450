...
class MiniPyCodeListener(ParseTreeListener):
    ...
    # Exit a parse tree produced by MiniPyCodeParser#while_stmt.
    def exitWhile_stmt(self, ctx:MiniPyCodeParser.While_stmtContext):
        pass


    # Enter a parse tree produced by MiniPyCodeParser#for_stmt.
    def enterFor_stmt(self, ctx:MiniPyCodeParser.For_stmtContext):
        pass
